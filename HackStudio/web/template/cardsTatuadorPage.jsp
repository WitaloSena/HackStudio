<%-- 
    Document   : botoesTatuador
    Created on : 21/05/2019, 11:24:00
    Author     : witalo.sena
--%>
<ol class="breadcrumb">
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
        <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
                ...
                <div class="mr-5">Novo tatuador</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="novo-tatuador.jsp">
